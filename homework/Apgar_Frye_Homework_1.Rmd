...
Next, we will rename each pxbx+1 value to be mo, m1, m2, or m3, and construct the leslie matrix. Then we will multiply the leslie matrix by the projection matrix two times to receive the project number of individuals at each age class over the next two years. 

```{r}
m <- c(1.00, 1.15, 1.40, 1.00)
mo
